...
class Notification(Base):
    ...
    med_rep = relationship("app.models.users.Users", backref="notifications", cascade="all, delete", foreign_keys=[med_rep_id], primaryjoin="Notification.med_rep_id == app.models.users.Users.id")
    region_manager_id = Column(Integer, ForeignKey("users.id"))
    region_manager = relationship("app.models.users.Users", backref="rm_notifications", foreign_keys=[region_manager_id], primaryjoin="Notification.region_manager_id == app.models.users.Users.id")
    pharmacy_id = Column(Integer, ForeignKey("pharmacy.id", ondelete="CASCADE"))
