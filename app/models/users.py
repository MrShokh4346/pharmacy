...
class Notification(Base):
    ...
    med_rep = relationship("app.models.users.Users", primaryjoin="app.models.users.Notification.med_rep_id == app.models.users.Users.id", backref="notifications", cascade="all, delete", foreign_keys=[med_rep_id])
